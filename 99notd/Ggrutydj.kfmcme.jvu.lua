...
local Window = Rayfield:CreateWindow({
   ...
   Discord = {
      ...
      Invite = "https://discord.gg/yrE3aXgtjH", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
   ...
   KeySettings = {
      ...
      Subtitle = "Key System",
      Note = "https://discord.gg/yrE3aXgtjH", -- Use this to tell the user how to get a key
      ...
      Key = {"ROBIKISTOP"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
